            ...
            <VCard title="Nouveau Module" subtitle="Hello guys veillez renseigné les informations de votre module.">
              <VForm ref="new_module" @submit.prevent="new_module">
                <VCardText>
                  <VRow>
                    <VCol md="6" cols="12">
                      <VTextField v-model="module.nom" label="Nom" density="compact" prepend-inner-icon="mdi-book-settings-outline" />
                    </VCol>

                    <VCol md="6" cols="12">
                      <VTextField  v-model="module.sigle" label="Sigle" density="compact"
                        prepend-inner-icon="mdi-book-open-page-variant-outline" />
                    </VCol>

                    <VCol cols="12">
                      <VTextarea  v-model="module.description" prepend-inner-icon="mdi-comment-outline" label="Description" rows="3" />
                    </VCol>
                  </VRow>
                </VCardText>
